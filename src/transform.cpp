...
namespace graf{
    void Transform::moveForward(float length)
    {
        position += forward*length;
    }

    void Transform::moveBackward(float length)
    {
        position -= forward*length;
    }

    void Transform::moveLeft(float length)
    {
        position -= right*length;
    }

    void Transform::moveRight(float length)
    {
        position += right*length;
    }
    ...
    Transform::~Transform()
    {
        std::cout << "Deleted transform settings successfully." << std::endl;
    }
